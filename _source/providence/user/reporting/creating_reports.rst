...
Create a Set of records from the databse. For instructions and more information, see `Sets <https://manual.collectiveaccess.org/providence/user/workflow/sets.html>`_. 
