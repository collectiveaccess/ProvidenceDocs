...
For further details about the mirror configuration see `FTP Mirror Configuration <https://manual.collectiveaccess.org/providence/user/configuration/developer/media_volumes.conf.html#ftp-mirror-configuration>`_ in `Media_volumes.conf <https://manual.collectiveaccess.org/providence/user/configuration/developer/media_volumes.conf.html>`_. 
