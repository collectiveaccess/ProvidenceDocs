...
See also: `User Interfaces <https://manual.collectiveaccess.org/providence/user/editing/interfaces.html>`_ and `User Interface Settings <https://manual.collectiveaccess.org/providence/user/reference/settings/userInterfaceSettings.html>`_. 
